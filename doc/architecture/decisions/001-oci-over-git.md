...
- **Requires OCI registry infrastructure.** The Tooling Cluster must run Harbor (on-prem) or have access to a managed OCI registry (cloud). This is already a requirement for container image distribution.
