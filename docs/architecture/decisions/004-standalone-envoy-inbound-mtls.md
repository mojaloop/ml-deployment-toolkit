...
[docs](../../index.md) / [architecture](../index.md) / [decisions](./) / 004 — Standalone Envoy Deployment for inbound DFSP mTLS
...
- **Extra Deployment.** 2 Envoy pods per App Environment, adding ~200Mi RAM overhead.
